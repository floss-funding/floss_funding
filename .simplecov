# kettle-jem:freeze
# To retain chunks of comments & code during floss_funding templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# floss_funding will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
...
SimpleCov.configure do
  ...
  # GemMine is test infrastructure, not Floss Funding library code.
  skip "gem_mine"
end
