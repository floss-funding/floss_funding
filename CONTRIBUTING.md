...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/floss_funding/my_class.rb` -> `spec/floss_funding/my_class_spec.rb`.
...
[🧪build]: https://github.com/galtzo-floss/floss_funding/actions
