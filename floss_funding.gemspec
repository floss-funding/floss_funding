...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/floss_funding/version.rb", mod) }::FlossFunding::Error::Version::VERSION
  else
    ...
    FlossFunding::Error::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "floss_funding"
  ...
  spec.licenses = ["MIT"]
  spec.required_ruby_version = ">= 1.9.2" # rubocop:disable Gemspec/RequiredRubyVersion
  ...
  spec.metadata["homepage_uri"] = "https://floss-funding.galtzo.com/"
  ...
  spec.files = [
    ...
    *enumerate_package_glob.call(File.join(gemspec_root, "base.txt"))
  ]
  spec.rdoc_options += [
    "--title",
  ...
  #       This gem, and its gemspec runtime dependencies, will install on Ruby down to 1.9.2.
